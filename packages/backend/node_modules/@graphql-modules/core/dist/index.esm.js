...
import { mergeSchemas, mergeSchemasAsync, mergeTypeDefs, mergeResolvers } from '@graphql-toolkit/schema-merging';
import { composeResolvers, getSchemaDirectiveFromDirectiveResolver, printSchemaWithDirectives } from '@graphql-toolkit/common';
import { Injector, ProviderScope } from '@graphql-modules/di';
import { parse, GraphQLSchema, GraphQLScalarType } from 'graphql';
    ...
    class GraphQLModule {
        ...
        get schemaDirectives() {
            if (typeof this._cache.schemaDirectives === 'undefined') {
                ...
                this._cache.schemaDirectives = all([...schemaDirectivesSet]);
            }
...
export { DependencyModuleNotFoundError, DependencyModuleUndefinedError, GraphQLModule, ModuleConfig, ModuleConfigRequiredError, ModuleSessionInfo, ProviderClassNotDecoratedError, SchemaNotValidError, TypeDefNotFoundError };
