...
class Injector {
    constructor(options = {}) {
        ...
        this._injectorScope = this.options.injectorScope || exports.ProviderScope.Application;
    ...
    getScopeInstanceMap(providerScope = this._injectorScope) {
        switch (providerScope) {
            case exports.ProviderScope.Application:
                return this._applicationScopeInstanceMap;
            case exports.ProviderScope.Session:
    ...
    has(serviceIdentifier) {
        return (this.getScopeInstanceMap(exports.ProviderScope.Application).has(serviceIdentifier) ||
            this.getScopeInstanceMap(exports.ProviderScope.Session).has(serviceIdentifier) ||
    ...
    get(serviceIdentifier, dependencyIndex) {
        const applicationScopeInstanceMap = this.getScopeInstanceMap(exports.ProviderScope.Application);
        const sessionScopeInstanceMap = this.getScopeInstanceMap(exports.ProviderScope.Session);
    ...
    getSessionInjector(session) {
        if (!this._sessionSessionInjectorMap.has(session)) {
            const sessionInjector = new Injector({
                ...
                injectorScope: exports.ProviderScope.Session,
                hooks: this._hooks,
...
exports.DESIGN_PARAMTYPES = DESIGN_PARAMTYPES;
